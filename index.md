...
EcoTherapy AI is positioned as a **wellness companion**, not a clinical instrument. It does not collect biometric sensor data, clinical records, location, or anything from your camera, microphone, contacts, calendar, or media.
...
| What | When |
| --- | --- |
| **Email address** (from Google Sign-in) | When you sign in |
...
- **Google** — for sign-in. Google sees only that you signed in; we receive only the email address you choose to share.
...
- **Anthropic** — provides the AI that replies to your chat messages. Before each message leaves our servers, we **replace your account identifier with a one-way cryptographic hash** so the message Anthropic receives is not linked to your name, email, or any user-stable identifier.
- **A crash reporting service** (only when active) — receives stack traces if the app crashes. Configured to exclude your IP address, device identifier, and email.
...
The **"About me"** screen in the app (Profile → About me) shows everything stored under your account. Nothing the app knows about you is hidden from this screen.

### Correct what we know about you
Tap **About me → "Edit my preferences"** to overwrite any field. Tap **"Clear my self-reported context"** to delete the optional paragraph you wrote at onboarding.
...
- **MENTARI (Ministry of Health):** 15999
...
We do not store passwords because we do not use passwords — sign-in is delegated to Google.
